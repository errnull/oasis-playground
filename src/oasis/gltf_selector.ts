...
const envList = {
  ...
  foot_2K:
    "https://gw.alipayobjects.com/os/bmw-prod/f0a011c2-ffba-4f70-866e-63974fff4ba9.bin",
};
...
export class Oasis {
  ...
  initScene() {
    ...
    this.lightEntity1.transform.setRotation(30.0, 0.0, 0.0);
    this.lightEntity2.transform.setRotation(-30.0, 180.0, 0.0);
  ...
  loadGLTF(url: string) {
    ...
    this.engine.resourceManager
      .load<GLTFResource>({
        ...
        url: `${url}#${Math.random()}.${isGLB ? "glb" : "gltf"}`,
      })
      .then((asset) => {
  ...
  setCenter(renderers: Renderer[]) {
    ...
    this.controller.target.setValue(center.x, center.y, center.z);
