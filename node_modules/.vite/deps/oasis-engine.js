...
var _class$c;
var _descriptor$c;
var EventDispatcher = (_class$c = function() {
  function EventDispatcher2() {
    _initializerDefineProperty(this, "_evts", _descriptor$c, this);
    this._evtCount = 0;
  }
...
}(), _descriptor$c = _applyDecoratedDescriptor(_class$c.prototype, "_evts", [ignoreClone], {
  configurable: true,
  enumerable: true,
  writable: true,
...
var _descriptor2$a;
var _class2$8;
var EngineObject = (_class$b = (_class2$8 = function() {
...
}(), _class2$8._instanceIdCounter = 0, _class2$8), _descriptor$b = _applyDecoratedDescriptor(_class$b.prototype, "instanceId", [ignoreClone], {
  configurable: true,
  enumerable: true,
  writable: true,
...
function dependencies() {
  for (var _len = arguments.length, componentClass = new Array(_len), _key = 0; _key < _len; _key++) {
    componentClass[_key] = arguments[_key];
  }
  return function(target) {
    componentClass.forEach(function(component) {
      return ComponentsDependencies.register(target, component);
    });
  };
}
var Layer;
...
var _descriptor3$8;
var _descriptor4$8;
var Component = (_class$a = function(_EngineObject) {
...
var _descriptor13$2;
var _class2$7;
var Transform = (_class$9 = (_class2$7 = function(_Component) {
...
var BoxColliderShape = function(_ColliderShape) {
  _inheritsLoose(BoxColliderShape2, _ColliderShape);
  ...
  _createClass(BoxColliderShape2, [{
    key: "size",
    get: function get4() {
      return this._size;
    },
...
var SphereColliderShape = function(_ColliderShape) {
  _inheritsLoose(SphereColliderShape2, _ColliderShape);
  ...
  _createClass(SphereColliderShape2, [{
    key: "radius",
    get: function get4() {
      return this._radius;
    },
...
var PlaneColliderShape = function(_ColliderShape) {
  _inheritsLoose(PlaneColliderShape2, _ColliderShape);
  ...
  _createClass(PlaneColliderShape2, [{
    key: "rotation",
    get: function get4() {
      return this._rotation;
    },
...
var CapsuleColliderShape = function(_ColliderShape) {
  _inheritsLoose(CapsuleColliderShape2, _ColliderShape);
  ...
  _createClass(CapsuleColliderShape2, [{
    key: "radius",
    get: function get4() {
      return this._radius;
    },
...
var _class$8;
var _descriptor$8;
var Collider = (_class$8 = function(_Component) {
...
var StaticCollider = function(_Collider) {
  _inheritsLoose(StaticCollider2, _Collider);
...
var DynamicCollider = function(_Collider) {
  _inheritsLoose(DynamicCollider2, _Collider);
...
(function(PointerPhase2) {
  ...
  PointerPhase2[PointerPhase2["Up"] = 2] = "Up";
  PointerPhase2[PointerPhase2["Leave"] = 3] = "Leave";
...
var PointerManager = function() {
  ...
  _proto._handlePointerEvent = function _handlePointerEvent(nativeEvents) {
    var pointers = this._pointers, keyEventList = this._keyEventList;
    ...
    if (pointerCount > 0) {
      var canvas = this._canvas, currentPosition = this._currentPosition;
      var pixelRatioWidth = canvas.width / canvas._webCanvas.clientWidth;
  ...
  _proto._firePointerUpAndClick = function _firePointerUpAndClick(rayCastEntity) {
    ...
    if (pressedEntity) {
      ...
      for (var i = scripts.length - 1; i >= 0; i--) {
        var script2 = scripts.get(i);
        sameTarget && script2.onPointerClick();
        script2.onPointerUp();
      }
      this._currentPressedEntity = null;
    }
...
var common = "#define GLSLIFY 1\n#define PI 3.14159265359\n#define RECIPROCAL_PI 0.31830988618\n#define EPSILON 1e-6\n#define LOG2 1.442695\n#define saturate( a ) clamp( a, 0.0, 1.0 )\n#define whiteCompliment(a) ( 1.0 - saturate( a ) )\nvec4 RGBMToLinear(vec4 value,float maxRange){return vec4(value.rgb*value.a*maxRange,1.0);}vec4 gammaToLinear(vec4 srgbIn){return vec4(pow(srgbIn.rgb,vec3(2.2)),srgbIn.a);}vec4 linearToGamma(vec4 linearIn){return vec4(pow(linearIn.rgb,vec3(1.0/2.2)),linearIn.a);}";
...
var ShaderData = function() {
  function ShaderData2(group) {
    this._group = void 0;
    this._properties = /* @__PURE__ */ Object.create(null);
    this._macroCollection = new ShaderMacroCollection();
    this._variableMacros = /* @__PURE__ */ Object.create(null);
    this._refCount = 0;
    this._group = group;
  }
...
var _descriptor16;
var _class2$6;
var Renderer = (_class$7 = (_class2$6 = function(_Component) {
  ...
  function Renderer2(entity) {
    ...
    _initializerDefineProperty(_this, "_mvInvMatrix", _descriptor14$1, _assertThisInitialized(_this));
...
}), _descriptor14$1 = _applyDecoratedDescriptor(_class$7.prototype, "_mvInvMatrix", [ignoreClone], {
  configurable: true,
  enumerable: true,
  writable: true,
...
var _descriptor6$5;
var _class2$5;
var SpriteMask = (_class$6 = (_class2$5 = function(_Renderer) {
  ...
  function SpriteMask2(entity) {
    ...
    _initializerDefineProperty(_this, "_worldMatrixDirtyFlag", _descriptor2$6, _assertThisInitialized(_this));
    _initializerDefineProperty(_this, "_sprite", _descriptor3$5, _assertThisInitialized(_this));
    _initializerDefineProperty(_this, "_alphaCutoff", _descriptor4$5, _assertThisInitialized(_this));
    _initializerDefineProperty(_this, "_spriteDirty", _descriptor5$5, _assertThisInitialized(_this));
  ...
  return SpriteMask2;
}(Renderer), _class2$5._textureProperty = Shader.getPropertyByName("u_maskTexture"), _class2$5._alphaCutoffProperty = Shader.getPropertyByName("u_maskAlphaCutoff"), _class2$5._tempVec3 = new Vector3(), _class2$5), _descriptor$6 = _applyDecoratedDescriptor(_class$6.prototype, "_positions", [deepClone], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor2$6 = _applyDecoratedDescriptor(_class$6.prototype, "_worldMatrixDirtyFlag", [ignoreClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor3$5 = _applyDecoratedDescriptor(_class$6.prototype, "_sprite", [ignoreClone], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor4$5 = _applyDecoratedDescriptor(_class$6.prototype, "_alphaCutoff", [assignmentClone], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor5$5 = _applyDecoratedDescriptor(_class$6.prototype, "_spriteDirty", [ignoreClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
...
var _descriptor2$5;
var _class2$4;
var MeshRenderer = (_class$5 = (_class2$4 = function(_Renderer) {
...
var _descriptor6$4;
var _class2$3;
var SkinnedMeshRenderer = (_class$4 = (_class2$3 = function(_MeshRenderer) {
...
}(MeshRenderer), _class2$3._blendShapeMacro = Shader.getMacroByName("OASIS_BLENDSHAPE"), _class2$3._blendShapeNormalMacro = Shader.getMacroByName("OASIS_BLENDSHAPE_NORMAL"), _class2$3._blendShapeTangentMacro = Shader.getMacroByName("OASIS_BLENDSHAPE_TANGENT"), _class2$3._jointCountProperty = Shader.getPropertyByName("u_jointCount"), _class2$3._jointSamplerProperty = Shader.getPropertyByName("u_jointSampler"), _class2$3._jointMatrixProperty = Shader.getPropertyByName("u_jointMatrix"), _class2$3._blendShapeWeightsProperty = Shader.getPropertyByName("u_blendShapeWeights"), _class2$3._maxJoints = 0, _class2$3), _descriptor$4 = _applyDecoratedDescriptor(_class$4.prototype, "matrixPalette", [ignoreClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
...
var PrimitiveMesh = function() {
  ...
  PrimitiveMesh2.createCapsule = function createCapsule(engine, radius, height, radialSegments, heightSegments, noLongerAccessible) {
    ...
    PrimitiveMesh2._createCapsuleCap(radius, height, radialSegments, doublePI, torsoVertexCount, 1, positions, normals, uvs, indices, indicesOffset);
    PrimitiveMesh2._createCapsuleCap(radius, height, radialSegments, -doublePI, torsoVertexCount + capVertexCount, -1, positions, normals, uvs, indices, indicesOffset + 6 * capRectangleCount);
    var bounds = mesh.bounds;
  ...
  _createClass(AmbientLight2, [{
    ...
    set: function set4(value) {
      ...
      if (!this._scene)
        return;
      if (value) {
        this._scene.shaderData.enableMacro(AmbientLight2._decodeRGBMMacro);
      } else {
        this._scene.shaderData.disableMacro(AmbientLight2._decodeRGBMMacro);
      }
    }
  }, {
    key: "diffuseMode",
    ...
    set: function set4(value) {
      ...
      if (!this._scene)
        return;
      if (value) {
        this._scene.shaderData.setFloatArray(AmbientLight2._diffuseSHProperty, this._preComputeSH(value, this._shArray));
      }
    }
  }, {
    ...
    set: function set4(value) {
      ...
      if (value) {
        ...
        shaderData.setFloat(AmbientLight2._mipLevelProperty, this._specularReflection.mipmapCount - 1);
...
var Engine = function(_EventDispatcher) {
  ...
  function Engine2(canvas, hardwareRenderer, physics, settings) {
    var _this;
  ...
  _proto.update = function update() {
    ...
    if (scene) {
      ...
      if (this.physicsManager) {
        ...
        this.physicsManager._update(deltaTime / 1e3);
...
var Camera = (_dec = dependencies(Transform), _dec(_class$2 = (_class2$2 = (_class3 = function(_Component) {
  ...
  _proto.worldToViewportPoint = function worldToViewportPoint(point, out) {
    ...
    out.setValue((viewportPoint.x / w + 1) * 0.5, (1 - viewportPoint.y / w) * 0.5, -cameraPoint.z);
    return out;
  };
...
var Sprite = function(_RefObject) {
  ...
  _proto.clone = function clone2() {
    var cloneSprite = new Sprite2(this._engine, this._texture, this._region, this._pivot, this._pixelsPerUnit, this.name);
...
var _descriptor14;
var _class2$1;
var SpriteRenderer = (_class$1 = (_class2$1 = function(_Renderer) {
  ...
  function SpriteRenderer2(entity) {
    ...
    _initializerDefineProperty(_this, "_spriteDirty", _descriptor12, _assertThisInitialized(_this));
    _initializerDefineProperty(_this, "_maskInteraction", _descriptor13, _assertThisInitialized(_this));
    _initializerDefineProperty(_this, "_maskLayer", _descriptor14, _assertThisInitialized(_this));
...
}(Renderer), _class2$1._textureProperty = Shader.getPropertyByName("u_spriteTexture"), _class2$1._tempVec3 = new Vector3(), _class2$1), _descriptor$1 = _applyDecoratedDescriptor(_class$1.prototype, "_customLocalBounds", [ignoreClone], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor4$1 = _applyDecoratedDescriptor(_class$1.prototype, "_sprite", [ignoreClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  ...
  writable: true,
  initializer: null
}), _descriptor12 = _applyDecoratedDescriptor(_class$1.prototype, "_spriteDirty", [ignoreClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor13 = _applyDecoratedDescriptor(_class$1.prototype, "_maskInteraction", [assignmentClone], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor14 = _applyDecoratedDescriptor(_class$1.prototype, "_maskLayer", [assignmentClone], {
  configurable: true,
  enumerable: true,
  writable: true,
...
(function(DirtyFlag2) {
  ...
  DirtyFlag2[DirtyFlag2["MaskInteraction"] = 2] = "MaskInteraction";
})(DirtyFlag || (DirtyFlag = {}));
...
var _descriptor7;
var _class2;
var Animator = (_class = (_class2 = function(_Component) {
  ...
  return Animator2;
}(Component), _class2._tempVector3 = new Vector3(), _class2._tempQuaternion = new Quaternion(), _class2._animatorInfo = new AnimatorStateInfo(), _class2), _descriptor = _applyDecoratedDescriptor(_class.prototype, "_speed", [assignmentClone], {
  configurable: true,
  enumerable: true,
  writable: true,
...
var AnimatorState = function() {
  ...
  _proto.addStateMachineScript = function addStateMachineScript(scriptType) {
    var script2 = new scriptType();
    script2._state = this;
    var prototype = StateMachineScript.prototype;
    if (script2.onStateEnter !== prototype.onStateEnter) {
      this._onStateEnterScripts.push(script2);
    }
    if (script2.onStateUpdate !== prototype.onStateUpdate) {
      this._onStateUpdateScripts.push(script2);
    }
    if (script2.onStateExit !== prototype.onStateExit) {
      this._onStateExitScripts.push(script2);
    }
    return script2;
  };
  ...
  _proto._removeStateMachineScript = function _removeStateMachineScript(script2) {
    var prototype = StateMachineScript.prototype;
    if (script2.onStateEnter !== prototype.onStateEnter) {
      var index = this._onStateEnterScripts.indexOf(script2);
      index !== -1 && this._onStateEnterScripts.splice(index, 1);
    }
    if (script2.onStateUpdate !== prototype.onStateUpdate) {
      var _index = this._onStateUpdateScripts.indexOf(script2);
      _index !== -1 && this._onStateUpdateScripts.splice(_index, 1);
    }
    if (script2.onStateExit !== prototype.onStateExit) {
      var _index2 = this._onStateExitScripts.indexOf(script2);
...
var ShadowFeature = function(_SceneFeature) {
  ...
  _proto.updatePassRenderFlag = function updatePassRenderFlag(renderQueue) {
    ...
    for (var i = 0, len = items.length; i < len; i++) {
      ...
      var receiveShadow = component.recieveShadow;
      var castShadow = component.castShadow;
      if (receiveShadow === true) {
        component.entity.layer |= Layer.Layer30;
      } else if (receiveShadow === false) {
        component.entity.layer &= ~Layer.Layer30;
      }
      if (castShadow === true) {
        component.entity.layer |= Layer.Layer31;
...
var WebGLEngine = function(_Engine) {
  ...
  function WebGLEngine2(canvas, physics, webGLRendererOptions) {
...
_dec$k = resourceLoader(AssetType.Buffer, ["bin", "r3bin"], false), _dec$k(_class$k = function(_Loader) {
...
var _dec$j;
var _class$j;
_dec$j = resourceLoader(AssetType.Prefab, ["gltf", "glb"]), _dec$j(_class$j = function(_Loader) {
...
var _dec$i;
var _class$i;
_dec$i = resourceLoader(AssetType.JSON, ["json"], false), _dec$i(_class$i = function(_Loader) {
...
var _dec$h;
var _class$h;
_dec$h = resourceLoader(AssetType.KTXCube, []), _dec$h(_class$h = function(_Loader) {
...
var _dec$g;
var _class$g;
_dec$g = resourceLoader(AssetType.KTX, ["ktx"]), _dec$g(_class$g = function(_Loader) {
...
var _dec$f;
var _class$f;
_dec$f = resourceLoader(AssetType.Texture2D, ["png", "jpg", "webp", "jpeg"]), _dec$f(_class$f = function(_Loader) {
...
var _dec$e;
var _class$e;
_dec$e = resourceLoader(AssetType.TextureCube, [""]), _dec$e(_class$e = function(_Loader) {
...
var _dec$d;
var _class$d;
_dec$d = resourceLoader(AssetType.SpriteAtlas, ["atlas"], false), _dec$d(_class$d = function(_Loader) {
...
var _dec$c;
var _class$c2;
_dec$c = resourceLoader(AssetType.Env, ["env"]), _dec$c(_class$c2 = function(_Loader) {
  _inheritsLoose3(EnvLoader, _Loader);
  function EnvLoader() {
    return _Loader.apply(this, arguments) || this;
  }
...
var _class$b2;
var _class22;
_dec$b = registerExtension("KHR_draco_mesh_compression"), _dec$b(_class$b2 = (_class22 = function(_ExtensionParser) {
...
}(ExtensionParser), _class22._decoder = void 0, _class22)) || _class$b2;
var _dec$a;
var _class$a2;
...
var AmbientLightResource = function(_SchemaResource) {
  _inheritsLoose3(AmbientLightResource2, _SchemaResource);
  function AmbientLightResource2() {
    return _SchemaResource.apply(this, arguments) || this;
  }
  var _proto = AmbientLightResource2.prototype;
  _proto.load = function load(resourceManager, assetConfig, oasis) {
    var _this = this;
    return new Promise(function(resolve, reject) {
...
var RESOURCE_TYPE = /* @__PURE__ */ new Map();
...
var SchemaResourceManager = (_dec$1 = pluginHook({
  ...
  function SchemaResourceManager2(oasis) {
    this.oasis = oasis;
    this.resourceMap = {};
    this.resourceIdMap = /* @__PURE__ */ new WeakMap();
    this.maxId = 0;
...
export {
  ...
  GLTFModel,
  GLTFResource$1 as GLTFResource,
  HitResult,
  IndexBufferBinding,
  IndexFormat,
  InputManager,
