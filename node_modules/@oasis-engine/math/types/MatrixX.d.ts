 ...
 */
export declare class MatrixX implements IClone {
     ...
     */
    static multiply(left: MatrixX, right: MatrixX, out: MatrixX): void;
    /**
     ...
     */
    static equals(left: MatrixX, right: MatrixX): boolean;
    /**
     ...
     */
    static lerp(start: MatrixX, end: MatrixX, t: number, out: MatrixX): void;
    /**
     ...
     */
    static rotationQuaternion(quaternion: Quaternion, out: MatrixX): void;
    /**
     ...
     */
    static rotationAxisAngle(axis: Vector3, r: number, out: MatrixX): void;
    /**
     ...
     */
    static rotationTranslation(quaternion: Quaternion, translation: Vector3, out: MatrixX): void;
    /**
     ...
     * @param out - The calculated matrix
     */
    static affineTransformation(scale: Vector3, rotation: Quaternion, translation: Vector3, out: MatrixX): void;
    /**
     * Calculate a matrix from scale vector.
     * @param s - The scale vector
     * @param out - The calculated matrix
     */
    static scaling(s: Vector3, out: MatrixX): void;
    /**
     * Calculate a matrix from translation vector.
     * @param translation - The translation vector
     * @param out - The calculated matrix
     */
    static translation(translation: Vector3, out: MatrixX): void;
    /**
     ...
     */
    static invert(a: MatrixX, out: MatrixX): void;
    /**
     ...
     */
    static lookAt(eye: Vector3, target: Vector3, up: Vector3, out: MatrixX): void;
    /**
     ...
     */
    static ortho(left: number, right: number, bottom: number, top: number, near: number, far: number, out: MatrixX): void;
    /**
     ...
     */
    static perspective(fovY: number, aspect: number, near: number, far: number, out: MatrixX): void;
    /**
     ...
     */
    static rotateAxisAngle(m: MatrixX, axis: Vector3, r: number, out: MatrixX): void;
    /**
     ...
     */
    static scale(m: MatrixX, s: Vector3, out: MatrixX): void;
    /**
     ...
     * @returns This matrix
     */
    setValue(m11: number, m12: number, m13: number, m14: number, m21: number, m22: number, m23: number, m24: number, m31: number, m32: number, m33: number, m34: number, m41: number, m42: number, m43: number, m44: number): MatrixX;
    /**
     ...
     * @returns This matrix
     */
    setValueByArray(array: ArrayLike<number>, offset?: number): MatrixX;
    /**
     ...
     */
    multiply(right: MatrixX): MatrixX;
    /**
