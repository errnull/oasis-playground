...
var AnimationParser = /*#__PURE__*/function (_Parser) {
      ...
      for (var _i2 = 0; _i2 < channels.length; _i2++) {
        ...
        switch (target.path) {
          case AnimationChannelTargetPath.TRANSLATION:
            ...
            interpolableValueType = core.InterpolableValueType.Vector3;
            break;

          case AnimationChannelTargetPath.ROTATION:
            compType = core.Transform;
            propertyName = "rotation";
            interpolableValueType = core.InterpolableValueType.Quaternion;
            break;
          ...
          case AnimationChannelTargetPath.WEIGHTS:
            ...
            interpolableValueType = core.InterpolableValueType.FloatArray;
            break;
        }
  ...
  _proto._addCurve = function _addCurve(interpolableValueType, gltfChannel, sampleDataCollection) {
    ...
    for (var j = 0, n = input.length; j < n; j++) {
      ...
      if (interpolableValueType === core.InterpolableValueType.Float) {
        var keyframe = new core.InterpolableKeyframe();
        keyframe.time = input[j];
        keyframe.inTangent = 0;
        keyframe.outTangent = 0;
        keyframe.value = output[offset];
        curve.addKey(keyframe);
      } else if (interpolableValueType === core.InterpolableValueType.FloatArray) {
      ...
      } else if (interpolableValueType === core.InterpolableValueType.Vector2) {
        var _keyframe2 = new core.InterpolableKeyframe();

        _keyframe2.time = input[j];
        _keyframe2.value = new math.Vector2(output[offset], output[offset + 1]);
        _keyframe2.inTangent = new math.Vector2();
        _keyframe2.outTangent = new math.Vector2();
        curve.addKey(_keyframe2);
      } else if (interpolableValueType === core.InterpolableValueType.Vector3) {
        var _keyframe3 = new core.InterpolableKeyframe();

        _keyframe3.time = input[j];
        _keyframe3.value = new math.Vector3(output[offset], output[offset + 1], output[offset + 2]);
        _keyframe3.inTangent = new math.Vector3();
        _keyframe3.outTangent = new math.Vector3();
        curve.addKey(_keyframe3);
      } else if (interpolableValueType === core.InterpolableValueType.Vector4) {
        var _keyframe4 = new core.InterpolableKeyframe();

        _keyframe4.time = input[j];
        _keyframe4.value = new math.Vector4(output[offset], output[offset + 1], output[offset + 2], output[offset + 3]);
        _keyframe4.inTangent = new math.Vector4();
        _keyframe4.outTangent = new math.Vector4();
        curve.addKey(_keyframe4);
      } else if (interpolableValueType === core.InterpolableValueType.Quaternion) {
        var _keyframe5 = new core.InterpolableKeyframe();

        _keyframe5.time = input[j];
        _keyframe5.value = new math.Quaternion(output[offset], output[offset + 1], output[offset + 2], output[offset + 3]);
        _keyframe5.inTangent = new math.Vector4();
        _keyframe5.outTangent = new math.Vector4();
  ...
  _proto.parse = function parse(context) {
    ...
    for (var i = 0; i < gltf.materials.length; i++) {
      ...
      if (pbrMetallicRoughness) {
        ...
        if (baseColorFactor) {
          material.baseColor = new math.Color(math.Color.linearToGammaSpace(baseColorFactor[0]), math.Color.linearToGammaSpace(baseColorFactor[1]), math.Color.linearToGammaSpace(baseColorFactor[2]), baseColorFactor[3]);
        }
      ...
      if (!KHR_materials_unlit) {
        ...
        if (emissiveFactor) {
          _m.emissiveColor = new math.Color(math.Color.linearToGammaSpace(emissiveFactor[0]), math.Color.linearToGammaSpace(emissiveFactor[1]), math.Color.linearToGammaSpace(emissiveFactor[2]));
        }
  ...
  _proto.load = function load(item, resourceManager) {
    return new core.AssetPromise(function (resolve, reject) {
      resourceManager.load({
        ...
        texture.filterMode = core.TextureFilterMode.Trilinear;
...
var _dec$b, _class$b, _class2;
(_dec$b = registerExtension("KHR_draco_mesh_compression"), _dec$b(_class$b = (_class2 = /*#__PURE__*/function (_ExtensionParser) {
...
}(ExtensionParser), _class2._decoder = void 0, _class2)) || _class$b);
...
(_dec$9 = registerExtension("KHR_materials_pbrSpecularGlossiness"), _dec$9(_class$9 = /*#__PURE__*/function (_ExtensionParser) {
  ...
  _proto.createEngineResource = function createEngineResource(schema, context) {
    ...
    if (diffuseFactor) {
      material.baseColor = new math.Color(math.Color.linearToGammaSpace(diffuseFactor[0]), math.Color.linearToGammaSpace(diffuseFactor[1]), math.Color.linearToGammaSpace(diffuseFactor[2]), diffuseFactor[3]);
    }
    ...
    if (specularFactor) {
      material.specularColor = new math.Color(math.Color.linearToGammaSpace(specularFactor[0]), math.Color.linearToGammaSpace(specularFactor[1]), math.Color.linearToGammaSpace(specularFactor[2]));
    }
