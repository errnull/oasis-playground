...
import { BaseResource, BlinnPhongMaterialResource, GLTFResource, PBRMaterialResource, PBRSpecularMaterialResource, SchemaResource, ScriptResource, SpriteResource, TextureCubeMapResource, TextureResource, UnlitMaterialResource, AnimatorControllerResource, AnimationClipResource, AmbientLightResource } from "./resources";
...
export declare const RESOURCE_CLASS: {
    ...
    sprite: typeof SpriteResource;
    SpriteAtlas: typeof SpriteAtlasResource;
    animatorController: typeof AnimatorControllerResource;
    animationClip: typeof AnimationClipResource;
    environment: typeof AmbientLightResource;
};
