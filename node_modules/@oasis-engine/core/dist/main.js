...
var SpriteMask = (_class$6 = (_class2$5 = /*#__PURE__*/function (_Renderer) {
  ...
  return SpriteMask;
}(Renderer), _class2$5._textureProperty = Shader.getPropertyByName("u_maskTexture"), _class2$5._alphaCutoffProperty = Shader.getPropertyByName("u_maskAlphaCutoff"), _class2$5._tempVec3 = new math.Vector3(), _class2$5), (_descriptor$6 = _applyDecoratedDescriptor(_class$6.prototype, "_positions", [deepClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
var Camera = (_dec = dependencies(Transform), _dec(_class$2 = (_class2$2 = (_class3 = /*#__PURE__*/function (_Component) {
  ...
  _proto.worldToViewportPoint = function worldToViewportPoint(point, out) {
    ...
    math.Vector3.transformCoordinate(point, this.viewMatrix, cameraPoint);
    math.Vector3.transformToVec4(cameraPoint, this.projectionMatrix, viewportPoint);
  ...
  _proto.viewportPointToRay = function viewportPointToRay(point, out) {
    ...
    math.Vector3.subtract(direction, origin, direction);
    direction.normalize();
    return out;
  }
  /**
  ...
  _proto._innerViewportToWorldPoint = function _innerViewportToWorldPoint(x, y, z, invViewProjMat, out) {
    ...
    math.Vector3.transformCoordinate(clipPoint, invViewProjMat, out);
    return out;
  };
  ...
  _proto._getInvViewProjMat = function _getInvViewProjMat() {
    if (this._isInvViewProjDirty.flag) {
      ...
      math.Matrix.multiply(this._transform.worldMatrix, this._getInverseProjectionMatrix(), this._invViewProjMat);
    }
...
}(Renderer), _class2$1._textureProperty = Shader.getPropertyByName("u_spriteTexture"), _class2$1._tempVec3 = new math.Vector3(), _class2$1), (_descriptor$1 = _applyDecoratedDescriptor(_class$1.prototype, "_customLocalBounds", [ignoreClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
var Animator = (_class = (_class2 = /*#__PURE__*/function (_Component) {
  ...
  return Animator;
}(Component), _class2._tempVector3 = new math.Vector3(), _class2._tempQuaternion = new math.Quaternion(), _class2._animatorInfo = new AnimatorStateInfo(), _class2), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "_speed", [assignmentClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
