...
var _class$c, _descriptor$c;

/**
 * EventDispatcher, which can be inherited as a base class.
 */
var EventDispatcher = (_class$c = /*#__PURE__*/function () {
...
var _class$b, _descriptor$b, _descriptor2$a, _class2$8;

/**
 * EngineObject.
 */
var EngineObject = (_class$b = (_class2$8 = /*#__PURE__*/function () {
...
var _class$9, _descriptor$9, _descriptor2$8, _descriptor3$7, _descriptor4$7, _descriptor5$7, _descriptor6$7, _descriptor7$5, _descriptor8$3, _descriptor9$3, _descriptor10$3, _descriptor11$3, _descriptor12$3, _descriptor13$2, _class2$7;
/**
 * Used to implement transformation related functions.
 */

var Transform = (_class$9 = (_class2$7 = /*#__PURE__*/function (_Component) {
...
var CapsuleColliderShape = /*#__PURE__*/function (_ColliderShape) {
  ...
  function CapsuleColliderShape() {
    ...
    _this._nativeShape.setUpAxis(exports.ColliderShapeUpAxis.Y);
...
var _class$7, _descriptor$7, _descriptor2$7, _descriptor3$6, _descriptor4$6, _descriptor5$6, _descriptor6$6, _descriptor7$4, _descriptor8$2, _descriptor9$2, _descriptor10$2, _descriptor11$2, _descriptor12$2, _descriptor13$1, _descriptor14$1, _descriptor15, _descriptor16, _class2$6;

/**
 * Renderable component.
 */
var Renderer = (_class$7 = (_class2$6 = /*#__PURE__*/function (_Component) {
...
var _class$6, _descriptor$6, _descriptor2$6, _descriptor3$5, _descriptor4$5, _descriptor5$5, _descriptor6$5, _class2$5;

/**
 * A component for masking Sprites.
 */
var SpriteMask = (_class$6 = (_class2$5 = /*#__PURE__*/function (_Renderer) {
  ...
  return SpriteMask;
}(Renderer), _class2$5._textureProperty = Shader.getPropertyByName("u_maskTexture"), _class2$5._alphaCutoffProperty = Shader.getPropertyByName("u_maskAlphaCutoff"), _class2$5._tempVec3 = new miniprogram.Vector3(), _class2$5), (_descriptor$6 = _applyDecoratedDescriptor(_class$6.prototype, "_positions", [deepClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
var _class$5, _descriptor$5, _descriptor2$5, _class2$4;

/**
 * MeshRenderer Component.
 */
var MeshRenderer = (_class$5 = (_class2$4 = /*#__PURE__*/function (_Renderer) {
...
var _class$4, _descriptor$4, _descriptor2$4, _descriptor3$4, _descriptor4$4, _descriptor5$4, _descriptor6$4, _class2$3;

/**
 * SkinnedMeshRenderer.
 */
var SkinnedMeshRenderer = (_class$4 = (_class2$3 = /*#__PURE__*/function (_MeshRenderer) {
...
var Engine = /*#__PURE__*/function (_EventDispatcher) {
  ...
  _proto.destroy = function destroy() {
    if (this._sceneManager) {
      ...
      this._resourceManager._destroy(); // If engine destroy, callComponentDestroy() maybe will not call anymore.
  ...
  _proto._drawRenderPass = function _drawRenderPass(pass, camera, cubeFace, mipLevel) {
    ...
    if (pass.enabled) {
      ...
      if (pass.renderOverride) {
        ...
        if (camera.clearFlags === exports.CameraClearFlags.DepthColor) {
...
var _dec, _class$2, _class2$2, _descriptor$2, _descriptor2$2, _descriptor3$2, _descriptor4$2, _descriptor5$2, _descriptor6$2, _descriptor7$2, _descriptor8$1, _descriptor9$1, _descriptor10$1, _descriptor11$1, _descriptor12$1, _class3;
...
var Camera = (_dec = dependencies(Transform), _dec(_class$2 = (_class2$2 = (_class3 = /*#__PURE__*/function (_Component) {
  ...
  _proto.worldToViewportPoint = function worldToViewportPoint(point, out) {
    ...
    miniprogram.Vector3.transformCoordinate(point, this.viewMatrix, cameraPoint);
    miniprogram.Vector3.transformToVec4(cameraPoint, this.projectionMatrix, viewportPoint);
  ...
  _proto.viewportPointToRay = function viewportPointToRay(point, out) {
    var invViewProjMat = this._getInvViewProjMat(); // Use the intersection of the near clipping plane as the origin point.
  ...
  _proto._innerViewportToWorldPoint = function _innerViewportToWorldPoint(x, y, z, invViewProjMat, out) {
    ...
    miniprogram.Vector3.transformCoordinate(clipPoint, invViewProjMat, out);
    return out;
  };
  ...
  _proto._getInvViewProjMat = function _getInvViewProjMat() {
    if (this._isInvViewProjDirty.flag) {
      ...
      miniprogram.Matrix.multiply(this._transform.worldMatrix, this._getInverseProjectionMatrix(), this._invViewProjMat);
    }
...
var _class$1, _descriptor$1, _descriptor2$1, _descriptor3$1, _descriptor4$1, _descriptor5$1, _descriptor6$1, _descriptor7$1, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _class2$1;

/**
 * Renders a Sprite for 2D graphics.
 */
var SpriteRenderer = (_class$1 = (_class2$1 = /*#__PURE__*/function (_Renderer) {
...
}(Renderer), _class2$1._textureProperty = Shader.getPropertyByName("u_spriteTexture"), _class2$1._tempVec3 = new miniprogram.Vector3(), _class2$1), (_descriptor$1 = _applyDecoratedDescriptor(_class$1.prototype, "_customLocalBounds", [ignoreClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
(function (DirtyFlag) {
  ...
  DirtyFlag[DirtyFlag["MaskInteraction"] = 2] = "MaskInteraction";
})(DirtyFlag || (DirtyFlag = {}));
...
var Animator = (_class = (_class2 = /*#__PURE__*/function (_Component) {
  ...
  return Animator;
}(Component), _class2._tempVector3 = new miniprogram.Vector3(), _class2._tempQuaternion = new miniprogram.Quaternion(), _class2._animatorInfo = new AnimatorStateInfo(), _class2), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "_speed", [assignmentClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
  ...
  _proto.updatePassRenderFlag = function updatePassRenderFlag(renderQueue) {
    ...
    for (var i = 0, len = items.length; i < len; i++) {
      ...
      if (receiveShadow === true) {
        component.entity.layer |= exports.Layer.Layer30; //SHADOW;
      } else if (receiveShadow === false) {
        component.entity.layer &= ~exports.Layer.Layer30; //SHADOW;
      }

      if (castShadow === true) {
        component.entity.layer |= exports.Layer.Layer31; //SHADOW_MAP;
